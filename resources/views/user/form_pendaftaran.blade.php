...
<div class="container-fluid">
            ...
            @error('nisn')
              <div class="alert alert-danger alert-dismissible fade show" role="alert">
                NISN yang anda masukkan telah terdaftar
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
              </div>
            @enderror
            ...
            <div class="card card-info">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="nama_lengkap" class="form-control" id="nama" placeholder="Sesuai Ijazah" value="@auth{{ auth()->user()->name}}@endauth" required>
                                </div>
                            </div>
                            <!-- OPTION -->
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="tempat_lahir" class="form-control" id="tempat_lahir" placeholder="Sesuai Ijazah" value="{{old('tempat_lahir')}}" required>
                                </div>
                            </div>
                            <!-- TANGGAL -->
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input type="date" name="tanggal_lahir" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask value="{{old('tanggal_lahir')}}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="alamat" class="form-control" id="alamat" placeholder="Sesuai KK" value="{{old('alamat')}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="Rt" class="col-sm-4 col-form-label">RT / RW (*)</label>
                                <div class="col-sm-4">
                                    <input type="text" name="rt" class="form-control" id="Rt" placeholder="000" value="{{old('rt')}}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                                </div>
                            <div class="col-sm-4">
                                <input type="text" name="rw" class="form-control" id="Rw" placeholder="000" value="{{old('rw')}}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                            </div>
                            </div>
                            <div class="form-group row">
                            <label for="Kelurahan" class="col-sm-4 col-form-label">KELURAHAN (*)</label>
                            <div class="col-sm-8">
                                <input type="text" name="kelurahan" value="{{old('kelurahan')}}" class="form-control" id="Kelurahan" placeholder="Kelurahan" required>
                            </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="kecamatan" class="form-control" value="{{old('kecamatan')}}" id="Kecamatan" placeholder="Kecamatan" required>
                        </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="provinsi" class="form-control" id="Propinsi" value="{{old('provinsi')}}" placeholder="Propinsi" required>
                        </div>
                        </div>
                        {{-- <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input type="text" class="form-control" name="no_telp" data-inputmask="'mask': ['999-999-999-999', '+0999 999 999 999']" data-mask value="{{old('no_telp')}}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required>
                            </div>
                        </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="email" name="email" class="form-control" id="Email" placeholder="Email" value="@auth{{ auth()->user()->email}}@endauth" required readonly>
                        </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="nama_ayah" class="form-control" id="nm_ayh" placeholder="Nama Ayah" required value="{{old('nama_ayah')}}">
                        </div>
                        </div>
                        <div class="form-group row">
                        <label for="tlahir_ayh" class="col-sm-4 col-form-label">TEMPAT LAHIR AYAH (*)</label>
                        <div class="col-sm-8">
                            <input type="text" name="tempat_lahir_ayah" class="form-control" id="tlahir_ayh" placeholder="Kota Lahir" value="{{old('tempat_lahir_ayah')}}">
                        </div>
                        </div>
                        <div class="form-group row">
                        <label for="lahir_ayh" class="col-sm-4 col-form-label">TANGGAL LAHIR AYAH(*)</label>
                        <div class="col-sm-8">
                            <input type="date" name="tgl_lahir_ayah" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask value="{{old('tgl_lahir_ayah')}}">
                        </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="nama_ibu" class="form-control" id="nm_ibu" placeholder="Nama Ibu" value="{{old('nama_ibu')}}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="tlahir_ibu" class="col-sm-4 col-form-label">TEMPAT LAHIR IBU (*)</label>
                                <div class="col-sm-8">
                                    <input type="text" name="tempat_lahir_ibu" class="form-control" id="tlahir_ibu" placeholder="Kota Lahir" value="{{old('tempat_lahir_ibu')}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="lahir_ibu" class="col-sm-4 col-form-label">TANGGAL LAHIR IBU (*)</label>
                                <div class="col-sm-8">
                                    <input type="date" name="tgl_lahir_ibu" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask value="{{old('tgl_lahir_ibu')}}">
                                </div>
                            </div>
                            <div class="form-group row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <label for="nm_ibu" class="col-sm-4 col-form-label">NAMA WALI</label>
                                <div class="col-sm-8">
                                    <input type="text" name="nama_wali" class="form-control" id="nm_ibu" placeholder="Nama Wali" value="{{old('nama_wali')}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="tlahir_ibu" class="col-sm-4 col-form-label">TEMPAT LAHIR WALI</label>
                                <div class="col-sm-8">
                                    <input type="text" name="tempat_lahir_wali" class="form-control" id="tlahir_ibu" placeholder="Kota Lahir" value="{{old('tempat_lahir_ibu')}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="lahir_ibu" class="col-sm-4 col-form-label">TANGGAL LAHIR WALI</label>
                                <div class="col-sm-8">
                                    <input type="date" name="tgl_lahir_wali" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask value="{{old('tgl_lahir_ibu')}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="Pend_Ibu" class="col-sm-4 col-form-label">PENDIDIKAN WALI</label>
                                <div class="col-sm-8">
                                    <select type="text" name="pendidikan_wali" id="pend_ibu" class="form-control">
                                    <option value="">-- Pilih --</option>
                                    <option value="Tidak Sekolah">Tidak Sekolah</option>
                                    <option value="Putus SD">Putus SD</option>
                                    <option value="SD Sederajad">SD Sederajad</option>
                            ...
                            <div class="form-group row">
                                <label for="kerja_ibu" class="col-sm-4 col-form-label">PEKERJAAN WALI</label>
                                <div class="col-sm-8">
                                    <select type="text" name="pekerjaan_wali" id="kerja_ibu" class="form-control">
                                    <option value="">-- Pilih --</option>
                                    <option value="Tidak bekerja">Tidak bekerja</option>
                                    <option value="Nelayan">Nelayan</option>
                                    <option value="Petani">Petani</option>
                            ...
                            <div class="form-group row">
                                <label for="hasil_ibu" class="col-sm-4 col-form-label">PENGHASILAN WALI</label>
                                <div class="col-sm-8">
                                    <select type="text" name="penghasilan_wali" id="hasil_ibu" class="form-control">
                                    <option value="">-- Pilih --</option>
                                    <option value="Kurang dari Rp. 500,000">Kurang dari Rp. 500,000</option>
                                    <option value="Rp. 500,000 - Rp. 999,999">Rp. 500,000 - Rp. 999,999</option>
                                    <option value="Rp. 1,000,000 - Rp. 1,999,999">Rp. 1,000,000 - Rp. 1,999,999</option>
                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <select type="text" name="jurusan" id="jurusan" class="form-control" value="{{old('jurusan')}}">
