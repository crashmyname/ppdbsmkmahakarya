                        ...
                        <thead>
                            ...
                            <tr align="center">
                                ...
                                <th><a href="/tampiluser/{{$item->id_siswa}}"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
                                  ...
                                  </svg></a> @if(!auth()->check() || auth()->user()->email !== 'kepalasekolah@gmail.com')|<a href="/tampildata/{{$item->id_siswa}}"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
