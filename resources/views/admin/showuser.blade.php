                ...
                <div class="card card-info">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="nama_wali" class="form-control" id="nm_ibu" placeholder="Nama Wali" value="{{$item->nama_wali}}" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="tlahir_ibu" class="col-sm-4 col-form-label">TEMPAT LAHIR WALI</label>
                            <div class="col-sm-8">
                                <input type="text" name="tempat_lahir_wali" class="form-control" id="tlahir_ibu" placeholder="Kota Lahir" value="{{$item->tempat_lahir_wali}}" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="lahir_ibu" class="col-sm-4 col-form-label">TANGGAL LAHIR WALI</label>
                            <div class="col-sm-8">
                                <input type="date" name="tgl_lahir_wali" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask value="{{$item->tgl_lahir_wali}}" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="Pend_Ibu" class="col-sm-4 col-form-label">PENDIDIKAN WALI</label>
                            <div class="col-sm-8">
                                <select type="text" name="pendidikan_wali" id="pend_ibu" class="form-control" readonly>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select type="text" name="pekerjaan_wali" id="kerja_ibu" class="form-control" readonly>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select type="text" name="penghasilan_wali" id="hasil_ibu" class="form-control" readonly>
