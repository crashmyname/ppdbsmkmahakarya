                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="nisn" class="form-control" id="Nisn" value="{{$item['nisn']}}" required maxlength="12">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            {{-- <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="nik" class="form-control" id="nik" value="{{$item['nik']}}" required>
                                </div>
                            </div> --}}
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="rt" class="form-control" id="Rt" value="{{$item['rt']}}" maxlength="4">
                                </div>
                            <div class="col-sm-4">
                                <input type="text" name="rw" class="form-control" id="Rw" value="{{$item['rw']}}" maxlength="4">
                            </div>
                            </div>
                            <div class="form-group row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input type="text" class="form-control" name="no_telp" data-inputmask="'mask': ['999-999-999-999', '+0999 999 999 999']" data-mask value="{{$item['no_telp']}}" required maxlength="13">
                            </div>
                        </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="no_kk" class="form-control" id="no_kk" value="{{$item['no_kk']}}" required>
                        </div>
                        </div> --}}
                    </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="nik_ayah" class="form-control" id="nik_ayh" value="{{$item['nik_ayah']}}" required>
                        </div>
                        </div> --}}
                        <div class="form-group row">
                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            ...
                            {{-- <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="nik_ibu" class="form-control" id="nik_ibu" value="{{$item['nik_ibu']}}" required>
                                </div>
                            </div> --}}
                            <div class="form-group row">
                ...
                <div class="card card-info">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="nama_wali" class="form-control" id="nm_ibu" placeholder="Nama Wali" value="{{$item->nama_wali}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="tlahir_ibu" class="col-sm-4 col-form-label">TEMPAT LAHIR WALI</label>
                            <div class="col-sm-8">
                                <input type="text" name="tempat_lahir_wali" class="form-control" id="tlahir_ibu" placeholder="Kota Lahir" value="{{$item->tempat_lahir_wali}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="lahir_ibu" class="col-sm-4 col-form-label">TANGGAL LAHIR WALI</label>
                            <div class="col-sm-8">
                                <input type="date" name="tgl_lahir_wali" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask value="{{$item->tgl_lahir_wali}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <option value="{{$item->pendidikan_wali}}">{{$item->pendidikan_wali}}</option>
                                <option value="Tidak Sekolah">Tidak Sekolah</option>
                                <option value="Putus SD">Putus SD</option>
                                <option value="SD Sederajad">SD Sederajad</option>
                                <option value="SMP Sederajad">SMP Sederajad</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <option value="{{$item->pekerjaan_wali}}">{{$item->pekerjaan_wali}}</option>
                                <option value="Tidak bekerja">Tidak bekerja</option>
                                <option value="Nelayan">Nelayan</option>
                                <option value="Petani">Petani</option>
                                <option value="Peternak">Peternak</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <option value="{{$item->penghasilan_wali}}">{{$item->penghasilan_wali}}</option>
                                <option value="Kurang dari Rp. 500,000">Kurang dari Rp. 500,000</option>
                                <option value="Rp. 500,000 - Rp. 999,999">Rp. 500,000 - Rp. 999,999</option>
                                <option value="Rp. 1,000,000 - Rp. 1,999,999">Rp. 1,000,000 - Rp. 1,999,999</option>
                                <option value="Rp. 2,000,000 - Rp. 4,999,999">Rp. 2,000,000 - Rp. 4,999,999</option>
